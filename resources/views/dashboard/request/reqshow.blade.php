      ...
      <div class="flex-1 text-center text-gray-600 p-2 m-1">
        ...
        <div class="shadow-sm max-w-3xl mx-auto rounded mt-2">
            ...
            <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                {{ $article->id }}
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">タイトル：{{ $article->plan_title }}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">メッセージ：{{ $article->message }}</p>
