  ...
  <div class="grid grid-cols-2 row-gap-8 md:grid-cols-3">
    <div class="text-center">
      <button
        ...
        type="button"
        class="text-green-800 bg-green-200 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        自由依頼
      </button>
    </div>
      @foreach($creator_plans as $plan)
         <div class="text-center">
          <button 
            ...
            class="text-blue-800 bg-blue-100 hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            {{ $plan->creator_plan_name }}
          </button>
        </div>      
      @endforeach
  </div>
    ...
    <div class="divide-y">
     ...
     <!-- person - start -->
      <div class="flex flex-col items-center bg-gray-100 rounded-lg p-4">
        ...
        <!-- stars - end -->
        <div>
          <div class="text-indigo-500 md:text-lg font-bold text-center">{{ $creator->creator_name }}</div>
          <p class="text-gray-500 text-sm md:text-base text-center mb-3 md:mb-4">Creator</p>
